{
  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        'branchmark/main.m',
        'branchmark/MBXBenchAppDelegate.h',
        'branchmark/MBXBenchAppDelegate.m',
        'branchmark/MBXBenchViewController.h',
        'branchmark/MBXBenchViewController.mm',
        'branchmark/locations.hpp',
        'branchmark/locations.cpp',
      ],
